...
export class ChartDrawingModule {
  ...
  // clearToolsOnly fires from onBeforeSeriesRemoved
  // loadDrawings fires from onDataReady via onSeriesDataReady
  ...
  // Tools already cleared by clearToolsOnly before series was removed
